...
guardian_issue:
  ...
  file_changes:
    - "create: docs/runbook-auth.md"
    - "create: docs/dr-plan-auth.md"
    - "modify: .pi/architecture/CHANGELOG.md"
    - "modify: .pi/architecture/modules/auth.md"
---

# Architecture Readiness: auth

## Intent

Make the auth module production-ready. This is the final issue in every epic
— it closes the loop between implementation and operability.

## Deliverables

### Runbook
`docs/runbook-auth.md` covering:
