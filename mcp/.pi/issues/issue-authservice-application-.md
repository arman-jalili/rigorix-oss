...
guardian_issue:
  id: "ISSUE-AUTH-1"
  epic: "TBD"
  component: "AuthService (Application)"
  module: "auth"
  status: planned
  priority: high
  dependencies:
  ...
  in_scope:
    - "Implement AuthService (Application) for the auth module"
  ...
  implementation_notes: |
    ...
    Component focus: AuthService (Application).
...
# ISSUE-AUTH-1: Implement AuthService (Application) — auth
...
> 2. Identify which rows are your responsibility for **AuthService (Application)**
