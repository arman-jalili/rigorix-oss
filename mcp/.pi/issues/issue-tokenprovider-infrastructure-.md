...
guardian_issue:
  id: "ISSUE-AUTH-4"
  epic: "TBD"
  component: "TokenProvider (Infrastructure)"
  module: "auth"
  status: planned
  priority: high
  dependencies:
  ...
  in_scope:
    - "Implement TokenProvider (Infrastructure) for the auth module"
  ...
  implementation_notes: |
    ...
    Component focus: TokenProvider (Infrastructure).
...
# ISSUE-AUTH-4: Implement TokenProvider (Infrastructure) — auth
...
> 2. Identify which rows are your responsibility for **TokenProvider (Infrastructure)**
