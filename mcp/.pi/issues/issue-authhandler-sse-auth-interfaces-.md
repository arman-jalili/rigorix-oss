...
guardian_issue:
  id: "ISSUE-AUTH-5"
  epic: "TBD"
  component: "AuthHandler / SSE Auth (Interfaces)"
  module: "auth"
  status: planned
  priority: high
  dependencies:
  ...
  in_scope:
    - "Implement AuthHandler / SSE Auth (Interfaces) for the auth module"
  ...
  implementation_notes: |
    ...
    Component focus: AuthHandler / SSE Auth (Interfaces).
...
# ISSUE-AUTH-5: Implement AuthHandler / SSE Auth (Interfaces) — auth
...
> 2. Identify which rows are your responsibility for **AuthHandler / SSE Auth (Interfaces)**
