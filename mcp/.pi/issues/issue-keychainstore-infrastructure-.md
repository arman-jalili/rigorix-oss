...
guardian_issue:
  id: "ISSUE-AUTH-3"
  epic: "TBD"
  component: "KeychainStore (Infrastructure)"
  module: "auth"
  status: planned
  priority: high
  dependencies:
  ...
  in_scope:
    - "Implement KeychainStore (Infrastructure) for the auth module"
  ...
  implementation_notes: |
    ...
    Component focus: KeychainStore (Infrastructure).
...
# ISSUE-AUTH-3: Implement KeychainStore (Infrastructure) — auth
...
> 2. Identify which rows are your responsibility for **KeychainStore (Infrastructure)**
