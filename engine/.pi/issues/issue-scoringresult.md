...
# ISSUE-SCORED-EVALUATION-6: Implement ScoringResult — scored-evaluation

## Intent

Implement **ScoringResult** for the `scored-evaluation` module.
...
> 2. Identify which rows are your responsibility for **ScoringResult**
