...
# ISSUE-APPROVAL-2: Implement IntentHash — approval

## Intent

Implement **IntentHash** for the `approval` module.
...
> 2. Identify which rows are your responsibility for **IntentHash**
