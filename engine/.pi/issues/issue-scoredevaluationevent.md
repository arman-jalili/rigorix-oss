---
guardian_issue:
  id: "ISSUE-SCORED-EVALUATION-8"
  epic: "TBD"
  component: "ScoredEvaluationEvent"
  ...
  in_scope:
    - "All three event variants serialize/deserialize correctly"
  ...
  implementation_notes: |
    ...
    Component focus: ScoredEvaluationEvent.
...
# ISSUE-SCORED-EVALUATION-8: Implement ScoredEvaluationEvent — scored-evaluation

## Intent

Implement **ScoredEvaluationEvent** for the `scored-evaluation` module.
...
| # | Criterion | Verify In |
|---|-----------|-----------|
| 10 | All three event variants serialize/deserialize correctly | unit test |
...
> 2. Identify which rows are your responsibility for **ScoredEvaluationEvent**
