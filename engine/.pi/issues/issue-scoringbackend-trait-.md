---
guardian_issue:
  id: "ISSUE-SCORED-EVALUATION-7"
  epic: "TBD"
  component: "ScoringBackend (Trait)"
  ...
  implementation_notes: |
    ...
    Component focus: ScoringBackend (Trait).
...
# ISSUE-SCORED-EVALUATION-7: Implement ScoringBackend (Trait) — scored-evaluation

## Intent

Implement **ScoringBackend (Trait)** for the `scored-evaluation` module.
...
> 2. Identify which rows are your responsibility for **ScoringBackend (Trait)**
