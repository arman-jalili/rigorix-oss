---
guardian_issue:
  id: "ISSUE-SEQUENCE-POLICY-10"
  epic: "TBD"
  component: "Fail-open-absent"
  ...
  in_scope:
    - "No config file → run executes unchanged"
  ...
  implementation_notes: |
    ...
    Component focus: Fail-open-absent.
...
# ISSUE-SEQUENCE-POLICY-10: Implement Fail-open-absent — sequence-policy

## Intent

Implement **Fail-open-absent** for the `sequence-policy` module.
...
| # | Criterion | Verify In |
|---|-----------|-----------|
| 11 | No config file → run executes unchanged | integration test |
...
> 2. Identify which rows are your responsibility for **Fail-open-absent**
