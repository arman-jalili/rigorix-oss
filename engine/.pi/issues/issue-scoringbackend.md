---
guardian_issue:
  id: "ISSUE-SCORED-EVALUATION-16"
  epic: "TBD"
  component: "ScoringBackend"
  ...
  in_scope:
    - "All three backend implementations pass same trait contract test suite"
  ...
  implementation_notes: |
    ...
    Component focus: ScoringBackend.
...
# ISSUE-SCORED-EVALUATION-16: Implement ScoringBackend — scored-evaluation

## Intent

Implement **ScoringBackend** for the `scored-evaluation` module.
...
| # | Criterion | Verify In |
|---|-----------|-----------|
| 5 | All three backend implementations pass same trait contract test suite | integration test |
...
> 2. Identify which rows are your responsibility for **ScoringBackend**
