...
guardian_issue:
  ...
  implementation_notes: |
    ...
    Component focus: IdentityRepository.
...
# ISSUE-IDENTITY-5: Implement IdentityRepository — identity

## Intent

Implement **IdentityRepository** for the `identity` module.
...
> 2. Identify which rows are your responsibility for **IdentityRepository**
