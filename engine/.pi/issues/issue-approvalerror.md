...
guardian_issue:
  ...
  in_scope:
    - "All variants, `Display`, `is_retriable()` (IntentMismatch → non-retriable)"
...
# ISSUE-APPROVAL-8: Implement ApprovalError — approval

## Intent

Implement **ApprovalError** for the `approval` module.
...
| # | Criterion | Verify In |
|---|-----------|-----------|
| 15 | All variants, `Display`, `is_retriable()` (IntentMismatch → non-retriable) | unit test |
...
> 2. Identify which rows are your responsibility for **ApprovalError**
