...
guardian_issue:
  ...
  implementation_notes: |
    ...
    Component focus: Domain Layer (`domain/`).
...
# ISSUE-SCORED-EVALUATION-1: Implement Domain Layer (`domain/`) — scored-evaluation

## Intent

Implement **Domain Layer (`domain/`)** for the `scored-evaluation` module.
...
> 2. Identify which rows are your responsibility for **Domain Layer (`domain/`)**
