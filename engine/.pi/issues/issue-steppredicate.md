---
guardian_issue:
  id: "ISSUE-SEQUENCE-POLICY-4"
  epic: "TBD"
  component: "StepPredicate"
  ...
  in_scope:
    - "Tool glob + param exact/glob/regex match correctly; non-matching params do not match"
...
# ISSUE-SEQUENCE-POLICY-4: Implement StepPredicate — sequence-policy

## Intent

Implement **StepPredicate** for the `sequence-policy` module.
...
| # | Criterion | Verify In |
|---|-----------|-----------|
| 2 | Tool glob + param exact/glob/regex match correctly; non-matching params do not match | unit test |
...
> 2. Identify which rows are your responsibility for **StepPredicate**
