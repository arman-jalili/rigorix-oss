---
guardian_issue:
  id: "ISSUE-SCORED-EVALUATION-4"
  epic: "TBD"
  component: "ScoredEvaluationNode"
  ...
  implementation_notes: |
    ...
    Component focus: ScoredEvaluationNode.
...
# ISSUE-SCORED-EVALUATION-4: Implement ScoredEvaluationNode — scored-evaluation

## Intent

Implement **ScoredEvaluationNode** for the `scored-evaluation` module.
...
> 2. Identify which rows are your responsibility for **ScoredEvaluationNode**
