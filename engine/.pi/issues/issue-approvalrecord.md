...
guardian_issue:
  ...
  implementation_notes: |
    ...
    Component focus: ApprovalRecord.
...
# ISSUE-APPROVAL-3: Implement ApprovalRecord — approval

## Intent

Implement **ApprovalRecord** for the `approval` module.
...
> 2. Identify which rows are your responsibility for **ApprovalRecord**
