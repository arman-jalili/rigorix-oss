...
guardian_issue:
  ...
  implementation_notes: |
    ...
    Component focus: Application Layer (`application/`).
...
# ISSUE-SCORED-EVALUATION-2: Implement Application Layer (`application/`) — scored-evaluation

## Intent

Implement **Application Layer (`application/`)** for the `scored-evaluation` module.
...
> 2. Identify which rows are your responsibility for **Application Layer (`application/`)**
