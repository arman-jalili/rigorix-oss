...
# ISSUE-IDENTITY-6: Implement IdentityError — identity

## Intent

Implement **IdentityError** for the `identity` module.
...
| 6 | RunInput.identity flows into envelope identity block (redacted) | integration test |
...
> 2. Identify which rows are your responsibility for **IdentityError**
