---
guardian_issue:
  id: "ISSUE-SCORED-EVALUATION-17"
  epic: "TBD"
  component: "ScoreAbove policy condition"
  ...
  in_scope:
    - "Policy condition correctly gates merge when dimension(s) below threshold"
  ...
  implementation_notes: |
    ...
    Component focus: ScoreAbove policy condition.
...
# ISSUE-SCORED-EVALUATION-17: Implement ScoreAbove policy condition — scored-evaluation

## Intent

Implement **ScoreAbove policy condition** for the `scored-evaluation` module.
...
| # | Criterion | Verify In |
|---|-----------|-----------|
| 12 | Policy condition correctly gates merge when dimension(s) below threshold | integration test |
...
> 2. Identify which rows are your responsibility for **ScoreAbove policy condition**
