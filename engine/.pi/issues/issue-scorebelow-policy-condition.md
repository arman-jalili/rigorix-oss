---
guardian_issue:
  id: "ISSUE-SCORED-EVALUATION-18"
  epic: "TBD"
  component: "ScoreBelow policy condition"
  ...
  in_scope:
    - "Policy condition correctly blocks merge when any dimension below threshold"
  ...
  implementation_notes: |
    ...
    Component focus: ScoreBelow policy condition.
...
# ISSUE-SCORED-EVALUATION-18: Implement ScoreBelow policy condition — scored-evaluation

## Intent

Implement **ScoreBelow policy condition** for the `scored-evaluation` module.
...
| # | Criterion | Verify In |
|---|-----------|-----------|
| 13 | Policy condition correctly blocks merge when any dimension below threshold | integration test |
...
> 2. Identify which rows are your responsibility for **ScoreBelow policy condition**
