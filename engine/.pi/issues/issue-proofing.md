...
guardian_issue:
  ...
  file_changes:
    - "create: .pi/scripts/ci/check_audit_contracts.sh"
    - "create: .pi/scripts/ci/check_audit_coverage.sh"
    - "modify: .pi/scripts/ci/run_hardening_stages.sh"
---

# Proofing & CI Enforcement: audit
...
|--------|---------|----------|
| check_audit_contracts.sh | Validate contract implementation | .pi/scripts/ci/ |
| check_audit_coverage.sh | Enforce coverage thresholds | .pi/scripts/ci/ |
| stage_audit_proofing.sh | CI stage wrapper | .pi/scripts/ci/ |
