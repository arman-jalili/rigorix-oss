---
guardian_issue:
  id: "ISSUE-SCORED-EVALUATION-12"
  epic: "TBD"
  component: "MCPBackend"
  ...
  in_scope:
    - "Sends `rigorix_evaluate_artifact` and parses MCP response into ScoringResult"
...
# ISSUE-SCORED-EVALUATION-12: Implement MCPBackend — scored-evaluation

## Intent

Implement **MCPBackend** for the `scored-evaluation` module.
...
| # | Criterion | Verify In |
|---|-----------|-----------|
| 6 | Sends `rigorix_evaluate_artifact` and parses MCP response into ScoringResult | integration test |
...
> 2. Identify which rows are your responsibility for **MCPBackend**
