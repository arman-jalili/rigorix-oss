...
# ISSUE-SCORED-EVALUATION-5: Implement Rubric — scored-evaluation

## Intent

Implement **Rubric** for the `scored-evaluation` module.
...
> 2. Identify which rows are your responsibility for **Rubric**
