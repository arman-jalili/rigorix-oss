...
guardian_issue:
  ...
  implementation_notes: |
    ...
    Component focus: ExecutionIntent.
...
# ISSUE-APPROVAL-1: Implement ExecutionIntent — approval

## Intent

Implement **ExecutionIntent** for the `approval` module.
...
> 2. Identify which rows are your responsibility for **ExecutionIntent**
