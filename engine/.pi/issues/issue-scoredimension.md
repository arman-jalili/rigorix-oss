...
guardian_issue:
  ...
  implementation_notes: |
    ...
    Component focus: ScoreDimension.
...
# ISSUE-SCORED-EVALUATION-15: Implement ScoreDimension — scored-evaluation

## Intent

Implement **ScoreDimension** for the `scored-evaluation` module.
...
> 2. Identify which rows are your responsibility for **ScoreDimension**
