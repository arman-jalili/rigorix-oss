...
guardian_issue:
  ...
  implementation_notes: |
    ...
    Component focus: Infrastructure Layer (`infrastructure/`).
...
# ISSUE-SCORED-EVALUATION-3: Implement Infrastructure Layer (`infrastructure/`) — scored-evaluation

## Intent

Implement **Infrastructure Layer (`infrastructure/`)** for the `scored-evaluation` module.
...
> 2. Identify which rows are your responsibility for **Infrastructure Layer (`infrastructure/`)**
