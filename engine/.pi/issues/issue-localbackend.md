...
guardian_issue:
  ...
  in_scope:
    - "Executes script with env vars, reads scoring result from stdout"
...
# ISSUE-SCORED-EVALUATION-14: Implement LocalBackend — scored-evaluation

## Intent

Implement **LocalBackend** for the `scored-evaluation` module.
...
| # | Criterion | Verify In |
|---|-----------|-----------|
| 8 | Executes script with env vars, reads scoring result from stdout | integration test |
...
> 2. Identify which rows are your responsibility for **LocalBackend**
