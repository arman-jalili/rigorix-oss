...
guardian_issue:
  ...
  implementation_notes: |
    ...
    Component focus: IdentitySource.
...
# ISSUE-IDENTITY-2: Implement IdentitySource — identity

## Intent

Implement **IdentitySource** for the `identity` module.
...
> 2. Identify which rows are your responsibility for **IdentitySource**
