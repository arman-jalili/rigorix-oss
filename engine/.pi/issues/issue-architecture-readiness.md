...
guardian_issue:
  ...
  file_changes:
    - "create: docs/runbook-approval.md"
    - "create: docs/dr-plan-approval.md"
    - "modify: .pi/architecture/CHANGELOG.md"
    - "modify: .pi/architecture/modules/approval.md"
---
...
Make the approval module production-ready. This is the final issue in every epic
— it closes the loop between implementation and operability.

## Deliverables

### Runbook
`docs/runbook-approval.md` covering:
...
### DR Plan
`docs/dr-plan-approval.md` covering:
