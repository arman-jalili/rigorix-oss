...
guardian_issue:
  ...
  file_changes:
    - "create: docs/runbook-failure-classification.md"
    - "create: docs/dr-plan-failure-classification.md"
    - "modify: .pi/architecture/CHANGELOG.md"
    - "modify: .pi/architecture/modules/failure-classification.md"
---

# Architecture Readiness: failure-classification

## Intent

Make the failure-classification module production-ready. This is the final issue in every epic
— it closes the loop between implementation and operability.

## Deliverables

### Runbook
`docs/runbook-failure-classification.md` covering:
...
### DR Plan
`docs/dr-plan-failure-classification.md` covering:
