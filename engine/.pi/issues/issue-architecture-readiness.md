...
guardian_issue:
  ...
  file_changes:
    - "create: docs/runbook-sequence-policy.md"
    - "create: docs/dr-plan-sequence-policy.md"
    - "modify: .pi/architecture/CHANGELOG.md"
    - "modify: .pi/architecture/modules/sequence-policy.md"
---

# Architecture Readiness: sequence-policy

## Intent

Make the sequence-policy module production-ready. This is the final issue in every epic
— it closes the loop between implementation and operability.

## Deliverables

### Runbook
`docs/runbook-sequence-policy.md` covering:
...
### DR Plan
`docs/dr-plan-sequence-policy.md` covering:
