...
# ISSUE-IDENTITY-1: Implement IdentityClaim — identity

## Intent

Implement **IdentityClaim** for the `identity` module.
...
> 2. Identify which rows are your responsibility for **IdentityClaim**
