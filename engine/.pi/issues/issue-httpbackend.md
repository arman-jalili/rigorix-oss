...
guardian_issue:
  ...
  in_scope:
    - "POSTs artifact + rubric to URL, parses JSON response"
...
# ISSUE-SCORED-EVALUATION-13: Implement HTTPBackend — scored-evaluation

## Intent

Implement **HTTPBackend** for the `scored-evaluation` module.
...
| # | Criterion | Verify In |
|---|-----------|-----------|
| 7 | POSTs artifact + rubric to URL, parses JSON response | integration test |
...
> 2. Identify which rows are your responsibility for **HTTPBackend**
