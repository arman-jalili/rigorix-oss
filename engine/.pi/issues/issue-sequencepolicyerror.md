---
guardian_issue:
  id: "ISSUE-SEQUENCE-POLICY-3"
  epic: "TBD"
  component: "SequencePolicyError"
  ...
  in_scope:
    - "All variants, `Display`, `is_retriable()`"
  ...
  implementation_notes: |
    ...
    Component focus: SequencePolicyError.
...
# ISSUE-SEQUENCE-POLICY-3: Implement SequencePolicyError — sequence-policy

## Intent

Implement **SequencePolicyError** for the `sequence-policy` module.
...
| # | Criterion | Verify In |
|---|-----------|-----------|
| 14 | All variants, `Display`, `is_retriable()` | unit test |
...
> 2. Identify which rows are your responsibility for **SequencePolicyError**
