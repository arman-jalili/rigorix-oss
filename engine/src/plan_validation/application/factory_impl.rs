...
impl QualityGateEvaluationService for QualityGateEvaluationAdapter {
    async fn evaluate_iteration(
        ...
        let classify_out = self.inner.classify_test_scope(classify_input).await
        ...
        let eval_out = self.inner.evaluate_gate(eval_input).await
            .map_err(|e| ValidationLoopError::QualityGateError {
        ...
        let failures = if passed {
            ...
            vec![crate::failure_parser::domain::TemplateFailure::TestFailure {
...
mod tests {
    ...
    use crate::quality_gates::application::service::QualityGateService;
    use crate::quality_gates::domain::{GreenContract, QualityLevel, QualityGateOutcome};
    use uuid::Uuid;
        ...
        async fn evaluate_gate(
            ...
            Ok(EvaluateGateOutput {
                outcome: if satisfied {
                    QualityGateOutcome::Satisfied { required: req, observed: obs.unwrap() }
                } else {
                    QualityGateOutcome::Unsatisfied { required: req, observed: obs.unwrap_or(QualityLevel::TargetedTests), gap: 1 }
                },
                summary: if satisfied { "Satisfied" } else { "Unsatisfied" }.to_string(),
    ...
    async fn test_create_default() {
        ...
        impl crate::planning::application::PlanningPipelineService for MockPlanning {
            async fn plan(&self, _: crate::planning::application::dto::PlanInput) -> Result<crate::planning::application::dto::PlanOutput, crate::planning::domain::PlanningError> { unimplemented!() }
            async fn plan_with_graph(&self, _: crate::planning::application::dto::PlanWithGraphInput) -> Result<crate::planning::application::dto::PlanWithGraphOutput, crate::planning::domain::PlanningError> { unimplemented!() }
            async fn check_budget(&self, _: crate::planning::application::dto::CheckBudgetInput) -> Result<crate::planning::application::dto::CheckBudgetOutput, crate::planning::domain::PlanningError> { unimplemented!() }
            ...
            async fn extract_parameters(&self, _: crate::planning::application::dto::ExtractParametersInput) -> Result<crate::planning::application::dto::ExtractParametersOutput, crate::planning::domain::PlanningError> { unimplemented!() }
            async fn generate_graph(&self, _: crate::planning::application::dto::GenerateGraphInput) -> Result<crate::planning::application::dto::GenerateGraphOutput, crate::planning::domain::PlanningError> { unimplemented!() }
            async fn validate_plan(&self, _: crate::planning::application::dto::ValidatePlanInput) -> Result<crate::planning::application::dto::ValidatePlanOutput, crate::planning::domain::PlanningError> { unimplemented!() }
            async fn request_clarification(&self, _: crate::planning::application::dto::RequestClarificationInput) -> Result<crate::planning::application::dto::RequestClarificationOutput, crate::planning::domain::PlanningError> { unimplemented!() }
            async fn available_templates(&self) -> Result<crate::planning::application::dto::AvailableTemplatesOutput, crate::planning::domain::PlanningError> { unimplemented!() }
            fn execution_id(&self) -> Uuid { Uuid::nil() }
        }

        use crate::failure_parser::domain::ParserRegistry;
        let parser = Box::new(crate::failure_parser::application::service_impl::FailureParserServiceImpl::new(
            ParserRegistry::new(),
        )) as Box<dyn FailureParserService>;
        let gate = Box::new(MockQualityGateService) as Box<dyn QualityGateService>;

        let result = factory.create_default(Box::new(MockPlanning), parser, gate).await;
        assert!(result.is_ok());
    }
    ...
    async fn test_create_custom() {
        ...
        let result = factory.create_custom(config, Box::new(MockPlanning), parser, gate).await;
        assert!(result.is_ok());
    }
    ...
    async fn test_adapter_evaluate_iteration_passes() {
        ...
        let result = adapter.evaluate_iteration(EvaluateIterationInput {
