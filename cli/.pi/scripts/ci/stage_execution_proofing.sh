...
echo "=== Execution Proofing ===" && echo ""
(cd "${REPO_ROOT}/cli" && bash "${SCRIPT_DIR}/check_execution_contracts.sh") 2>/dev/null && pass "check_execution_contracts.sh" || fail "check_execution_contracts.sh"
