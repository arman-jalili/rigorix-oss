...
guardian_issue:
  ...
  file_changes:
    - "create: docs/runbook-template.md"
    - "create: docs/dr-plan-template.md"
    - "modify: .pi/architecture/CHANGELOG.md"
    - "modify: .pi/architecture/modules/module-template.md"
---

# Architecture Readiness: module-template

## Intent

Make the module-template module production-ready. This is the final issue in every epic
— it closes the loop between implementation and operability.

## Deliverables

### Runbook
`docs/runbook-template.md` covering:
...
### DR Plan
`docs/dr-plan-template.md` covering:
