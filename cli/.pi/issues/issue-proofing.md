...
guardian_issue:
  ...
  file_changes:
    - "create: .pi/scripts/ci/check_template_contracts.sh"
    - "create: .pi/scripts/ci/check_template_coverage.sh"
    - "modify: .pi/scripts/ci/run_hardening_stages.sh"
---

# Proofing & CI Enforcement: module-template
...
|--------|---------|----------|
| check_template_contracts.sh | Validate contract implementation | .pi/scripts/ci/ |
| check_template_coverage.sh | Enforce coverage thresholds | .pi/scripts/ci/ |
| stage_template_proofing.sh | CI stage wrapper | .pi/scripts/ci/ |
...
```bash
run_stage "11" "template_proofing" \
