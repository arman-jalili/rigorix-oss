...
use crate::cli_boundary::infrastructure::output::LogFormatter;
use crate::configuration::domain::config::OutputFormat;
...
mod tests {
    use super::*;
    use crate::cli_boundary::application::dto::ExecutionSummary;
    ...
    fn test_quiet_format_run() {
        ...
        let output = RunOutput {
            ...
            outcome: crate::cli_boundary::domain::event::SessionOutcome::Completed,
